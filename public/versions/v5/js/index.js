function themeLoad()
{
    ...
    link.type = "text/css";
    link.rel = "stylesheet";
    link.href = `/versions/v5/css/palettes/${localStorage.getItem("isTheme")}.css`;
...
function animatedBackgroundLoad()
{
    ...
    {
        document.querySelector("main").style.backgroundImage = `url('/versions/v5/assets/animated-background.webp')`;
    }
    else
    {
        document.querySelector("main").style.backgroundImage  = `url('/versions/v5/assets/background.webp')`;
    }
}
